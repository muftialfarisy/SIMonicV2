...
public class Radar extends AppCompatActivity {
    ...
    private FloatingActionButton floatingActionButtonSetting,floatingActionButtonInterval;
    ...
    public void initializedLayout(){
        // setup UI
        Fragment selectedFragment = new BeaconRadar();
        getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, selectedFragment).commit();
        floatingActionButtonSetting = findViewById(R.id.fabsetting);
        floatingActionButtonInterval = findViewById(R.id.fabsettinginterval);
    }
